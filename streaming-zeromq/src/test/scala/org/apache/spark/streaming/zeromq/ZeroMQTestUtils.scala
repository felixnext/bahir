 ...
 */
private[zeromq] class ZeroMQTestUtils extends Logging {

  private val persistenceDir = Utils.createTempDir()
  private val publisherHost = "localhost"
  private val publisherPort = findFreePort()

  /*
  private var publisher: BrokerService = _
  private var systemUsage: SystemUsage = _
  private var connector: TransportConnector = _
  */

  def publisherUri: String = {
    s"$publisherHost:$publisherPort"
  }
